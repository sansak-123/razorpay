    ...
    <div className="fade-in-up">
      ...
      <div className="grid grid-cols-3 gap-px bg-ink-700 mb-10 rounded-sm overflow-hidden">
        <div className="bg-ink-800 px-4 py-3.5">
          <div className="font-mono text-[11.5px] uppercase tracking-wide text-text-dim mb-1">Batches</div>
          <div className="font-mono text-lg font-semibold text-text">{batches.length}</div>
        </div>
        <div className="bg-ink-800 px-4 py-3.5">
          <div className="font-mono text-[11.5px] uppercase tracking-wide text-text-dim mb-1">Total credited</div>
          <div className="font-mono text-lg font-semibold text-text">
            ₹{Math.round(totalCredited).toLocaleString("en-IN")}
          </div>
        </div>
        <div className="bg-ink-800 px-4 py-3.5">
          <div className="font-mono text-[11.5px] uppercase tracking-wide text-text-dim mb-1">Batches with a gap</div>
