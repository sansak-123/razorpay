  ...
  return (
    <div className="fade-in-up">
      ...
      <section className="mb-11">
        <div className="font-mono text-[11px] uppercase tracking-wide text-text-dim mb-1">
      ...
      <section>
        ...
        <div className="bg-ink-800 border border-ink-700 rounded-sm px-5 py-2">
          {[
            ...
            >
              <span className="text-[13px] text-text-dim whitespace-nowrap">{row.label}</span>
              <span className="flex-1 border-b border-dotted border-ink-600 translate-y-[-3px]" />
              <span className="font-mono text-[14px] font-semibold whitespace-nowrap text-text">
