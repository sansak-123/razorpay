...
// Reuses the dashboard's actual torn-receipt visual -- same computed real
// numbers, not a landing-page-only mockup -- and gives it a scroll-into-view
// reveal so it's the page's one genuinely interactive "unpacking" moment
// instead of a static screenshot-shaped section.
